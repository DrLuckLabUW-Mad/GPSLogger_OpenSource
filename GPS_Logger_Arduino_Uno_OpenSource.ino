/******************************************************************************
  ...
  Claire Rapant
  Undergrad Student Working with Dr. Brian Luck
  Biological Systems Engineering

  
  This code uses Arduino Uno and GP3906-TLP GPS Module

  This project is designed as an open source for those who want a low cost GPS
  tracker for farming equipment. Feel free to use for any other purposes.
  Source: https://github.com/DrLuckLabUW-Mad/GPSLogger_OpenSource
  
  Note: The code requires a baude rate of 9600.
******************************************************************************/
...
// Log Rate Control //
//////////////////////
#define LOG_RATE 5000 // Log every 5 second(s)
...
byte logGPSData()
{
  ...
  { // Print longitude, latitude, altitude (in feet), speed (in mph), course
    ...
    logFile.print(',');
    logFile.print(tinyGPS.time.hour()-5);     //Matches CST
